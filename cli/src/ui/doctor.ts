...
export function getEnvironmentInfo(): Record<string, any> {
    return {
        ...
        HAPI_DIAGNOSTIC_LOGGING: process.env.HAPI_DIAGNOSTIC_LOGGING,
...
export async function runDoctorCommand(filter?: 'all' | 'runner'): Promise<void> {
    ...
    if (filter === 'all') {
        ...
        console.log(`HAPI_DIAGNOSTIC_LOGGING: ${env.HAPI_DIAGNOSTIC_LOGGING ? chalk.green(env.HAPI_DIAGNOSTIC_LOGGING) : chalk.gray('not set')}`);
