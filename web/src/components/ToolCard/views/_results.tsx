...
export const toolResultViewRegistry: Record<string, ToolViewComponent> = {
    ...
    update_plan: TodoSingleRenderResultView,
    ...
    'mcp__codex__list_mcp_resources': ListMcpResourcesResultView,
    'mcp__codex__list_mcp_resource_templates': RawResultView,
    'mcp__codex__read_mcp_resource': RawResultView,
    'mcp__searxng__read_mcp_resource': RawResultView,
    CodexReasoning: CodexReasoningResultView,
    CodexPatch: CodexPatchResultView,
    apply_patch: CodexPatchResultView,
