export default {
  ...
  "scheduled.detail.nextRunTipPaused": "No next run is scheduled because this task is currently paused.",
  "scheduled.detail.nextRunTipOnceFinished": "No next run is scheduled because this one-time task has already been consumed or completed.",
  "scheduled.detail.nextRunTipUnavailable": "No next run is currently available. The scheduler has not computed one yet or this task is no longer runnable.",
