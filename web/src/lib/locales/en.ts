export default {
  ...
  'files.git.unavailable': 'Git status unavailable. Use Directories to browse all files, or search.',
  'files.git.noChanges': 'No changes detected. Use Directories to browse all files, or search.',
  ...
  'files.viewer.binary': 'This looks like a binary file. It cannot be displayed.',
  ...
  'newSession.planMode.desc': 'Enable autonomous planning mode for complex multi-step tasks.',
