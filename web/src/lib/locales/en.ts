export default {
  ...
  "scheduled.detail.selectedRun": "Selected Run",
  "scheduled.detail.selectedRunHint": "The selected run owns the session detail below.",
  ...
  "scheduled.detail.sessionViewHint": "Embedded session view for the selected run.",
  "scheduled.detail.openFullscreen": "Open Fullscreen",
  "scheduled.detail.openDeepLink": "Open via Deep Link",
