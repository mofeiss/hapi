export default {
  ...
  'scheduled.detail.selectedRun': '当前执行',
  'scheduled.detail.selectedRunHint': '下方展示的是当前选中执行对应的会话详情。',
  ...
  'scheduled.detail.sessionViewHint': '当前执行对应的嵌入式会话视图。',
  'scheduled.detail.openFullscreen': '全屏打开',
  'scheduled.detail.openDeepLink': '通过深链接打开',
