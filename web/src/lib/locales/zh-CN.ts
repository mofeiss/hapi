export default {
  ...
  'scheduled.detail.nextRunTipPaused': '当前没有下次执行时间，因为这个任务已被暂停。',
  'scheduled.detail.nextRunTipOnceFinished': '当前没有下次执行时间，因为这个单次任务已经执行完毕或已被消耗。',
  'scheduled.detail.nextRunTipUnavailable': '当前没有可用的下次执行时间，调度器尚未计算出来，或这个任务已经不再可运行。',
