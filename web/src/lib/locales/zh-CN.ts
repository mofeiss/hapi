export default {
  ...
  'scheduled.list.emptyTitle': '还没有定时任务',
  'scheduled.list.empty': '',
  'scheduled.list.tryIt': '试一下',
  'scheduled.list.examplePrompt': '每天早上 9 点查询天气情况',
  'scheduled.list.status.paused': '已暂停',
  'scheduled.list.status.failed': '失败',
  'scheduled.list.status.ready': '就绪',
  'scheduled.list.status.healthy': '正常',
  'scheduled.list.status.completed': '已完成',
  'scheduled.list.phase.enabled': '启用',
  'scheduled.list.phase.paused': '暂停',
  'scheduled.list.phase.archived': '归档',
  'scheduled.list.status.running': '执行中',
  'scheduled.list.status.active': '已启用',
  'scheduled.list.status.idle': '空闲',
  'scheduled.detail.displayStatusTip.succeeded': '这里的成功仅表示调度器已经成功创建并交付会话，不代表任务已经完成。只有会话上报了结果状态，任务才算真正完成。',
  'scheduled.detail.runStatusTip.succeededPendingOutcome': '这里的成功仅表示会话投递成功，不代表任务已完成；当前还没有收到结果状态上报。',
  'scheduled.list.meta.agent': 'Agent',
  'scheduled.list.meta.created': '创建',
  'scheduled.list.iconLabel': '定时任务状态',
  'scheduled.list.kind.once': '单次',
  'scheduled.list.kind.cron': '循环',
  'scheduled.detail.emptyTitle': '选择一个任务查看详情',
  'scheduled.detail.empty': '选中左侧的定时任务后，这里会显示它的配置、执行记录和关联会话。',
  'scheduled.detail.summary': '任务概览与管理区。只有在下方选中某次执行后，才会显示对应的会话详情。',
  'scheduled.detail.status': '状态',
  'scheduled.detail.displayStatus': '展示状态',
  'scheduled.detail.nextTime': '下次执行时间',
  'scheduled.detail.taskPhase': '任务阶段',
  'scheduled.detail.machine': '机器',
  'scheduled.detail.schedule': '调度类型',
  'scheduled.detail.agent': '代理',
  'scheduled.detail.created': '创建于',
  'scheduled.detail.createdFromSession': '来源会话',
  'scheduled.detail.createdFromSessionMissing': '不可用',
  'scheduled.detail.nextRun': '下次执行',
  'scheduled.detail.nextRunTipPaused': '已暂停，暂无下次执行。',
  'scheduled.detail.nextRunTipOnceFinished': '单次任务已结束，没有下次执行。',
  'scheduled.detail.nextRunTipUnavailable': '下次执行时间暂不可用。',
  'scheduled.time.startingSoon': '即将开始',
  'scheduled.time.inDaysOnly': '{days}天',
  'scheduled.time.hms': '{hours}:{minutes}:{seconds}',
  'scheduled.detail.lastRun': '上次执行',
  'scheduled.detail.prompt': '提示词',
  'scheduled.detail.config': '配置',
  'scheduled.detail.directory': '目录',
  'scheduled.detail.model': '模型',
  'scheduled.detail.permission': '会话权限',
  'scheduled.detail.timezone': '时区',
  'scheduled.detail.taskId': '任务 ID',
  'scheduled.detail.scheduleType': '调度类型',
  'scheduled.detail.runAt': '执行时间',
  'scheduled.detail.cron': 'Cron 表达式',
  'scheduled.detail.expression': '表达式',
  'scheduled.detail.runs': '执行记录',
  'scheduled.detail.runsHint': '每次执行都会挂在这个任务下。选择一条即可查看结果。',
  'scheduled.detail.runsEmpty': '这个任务还没有产生执行记录。',
  'scheduled.detail.previousRun': '上一条执行记录',
  'scheduled.detail.nextRunRecord': '下一条执行记录',
  'scheduled.detail.previousShort': '上一条',
  'scheduled.detail.nextShort': '下一条',
  'scheduled.detail.firstRun': '第一条执行记录',
  'scheduled.detail.runNumber': '第 {n} 条执行记录',
  'scheduled.detail.selectedRun': '执行结果',
  'scheduled.detail.outcome': '任务结果',
  'scheduled.detail.outcomeStatus': '结果状态',
  'scheduled.detail.outcomeReportedAt': '结果上报时间',
  'scheduled.detail.outcomeSummaryHint': '由计划任务会话主动上报，用来说明本次业务目标是否真正完成。',
  'scheduled.detail.needsUserIntervention': '需要用户介入',
  'scheduled.detail.permanentFailureLikely': '大概率永久失败',
  'scheduled.detail.pickRun': '选择一条执行记录查看详情。',
  ...
  'scheduled.detail.modeSwitcher': '定时任务详情模式',
  ...
  'scheduled.detail.mode.sessionDisabled': '请选择一个带有关联 session 的 run，再查看内嵌会话面板。',
  'scheduled.runResult.Scheduled prompt delivered to new session': '定时提示词已投递到新会话',
  'scheduled.runStatus.running': '运行中',
  'scheduled.runStatus.queued': '排队中',
  'scheduled.runStatus.succeeded': '成功',
  'scheduled.runStatus.failed': '失败',
  'scheduled.runStatus.canceled': '已取消',
  'scheduled.runStatus.missed': '已错过',
  'scheduled.permission.aware': '环境感知',
  'scheduled.permission.self_control': '仅可控制自身',
  'scheduled.permission.system_control': '可控制整个系统',
  'scheduled.outcomeStatus.completed': '已完成',
  'scheduled.outcomeStatus.partial': '部分完成',
  'scheduled.outcomeStatus.blocked': '受阻',
  'scheduled.outcomeStatus.abandoned': '已放弃',
  ...
  'files.search.refresh': '刷新',
  'files.search.loading': '加载文件…',
  'files.search.noMatch': '没有匹配的文件。',
  'files.search.noFiles': '此项目中未找到文件。',
  'files.git.loading': '加载 Git 状态…',
  'files.git.staged': '已暂存',
  'files.git.unstaged': '未暂存',
  'files.git.stagedChanges': '已暂存变更',
  'files.git.unstagedChanges': '未暂存变更',
  'files.git.unavailable': 'Git 状态不可用。使用目录浏览所有文件，或搜索。',
  'files.git.noChanges': '未检测到变更。使用目录浏览所有文件，或搜索。',
  'files.projectRoot': '项目根目录',
  'files.viewer.copyPath': '复制路径',
  'files.viewer.copyContent': '复制文件内容',
  'files.viewer.diff': '差异',
  'files.viewer.file': '文件',
  'files.viewer.binary': '这是一个二进制文件，无法显示。',
  'files.viewer.empty': '文件为空。',
  'files.viewer.noChanges': '没有可显示的变更。',
  'files.viewer.loading': '加载文件…',
  ...
  'newTask.title': '新任务',
  'newTask.empty.title': '开始新任务',
  'newTask.empty.subtitle': '选好目录与环境，然后告诉 HAPI 你想开始做什么。',
  'newSession.machine': '机器',
  'newSession.directory': '目录',
  'newSession.placeholder': '/path/to/project',
  'newSession.prompt.placeholder': '输入你想让 HAPI 现在开始做的事…',
  ...
  'newSession.model.custom.placeholder': '例如 codex',
  'newSession.model.custom.add': '添加',
  'newSession.reasoning': '思考等级',
  'newSession.reasoning.auto': '自动',
  'newSession.reasoning.none': '无',
  'newSession.reasoning.minimal': '最少',
  'newSession.reasoning.low': '低',
  'newSession.reasoning.medium': '中',
  'newSession.reasoning.high': '高',
  'newSession.reasoning.xhigh': '超高',
  'newSession.basePermission': '基础权限模式',
  'newSession.planMode.title': '计划模式',
  'newSession.planMode.desc': '开启自主计划模式以执行复杂的多步任务。',
  'permission.mode.default': '默认',
  'permission.mode.acceptEdits': '跳过编辑审批',
  'permission.mode.bypassPermissions': '全部跳过 (Bypass)',
  'permission.mode.plan': '计划模式',
  'permission.mode.read-only': '只读',
  'permission.mode.safe-yolo': 'Safe Yolo',
  'permission.mode.yolo': 'Yolo',
  'newSession.create': '创建',
  'newSession.creating': '创建中…',
  'newSession.createEmpty': '仅创建空白会话',
  'newSession.advanced.show': '更多设置',
  'newSession.advanced.hide': '收起设置',
  ...
  'machine.action.rename': '重命名',
  'machine.action.clearName': '恢复默认名称',
  'machine.rename.prompt': '机器名称',
  ...
  'settings.display.zoomMode': '缩放方式',
  'settings.display.zoomModeHint': '暂时停用应用内字体缩放，请使用浏览器原生缩放，如 Cmd/Ctrl + 加号、减号或触控板/鼠标缩放。',
  'settings.shortcuts.title': '快捷键',
  'settings.shortcuts.toggleSettings.title': '打开或关闭设置',
  'settings.shortcuts.toggleSettings.detail': '全平台可用，切换设置面板显示状态。',
  ...
  'settings.shortcuts.switchToSessions.title': '切换到会话',
  'settings.shortcuts.switchToSessions.detail': '切换到 Sessions 工作区标签。',
  'settings.shortcuts.switchToScheduled.title': '切换到计划任务',
  'settings.shortcuts.switchToScheduled.detail': '切换到 Scheduler 工作区标签。',
